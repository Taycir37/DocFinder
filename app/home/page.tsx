  ...
  return (
    <div className="min-h-screen bg-gradient-soft">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('/medical-research-team.png')] bg-cover bg-center opacity-10"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl transform rotate-1">
                <Image src="/doctor-patient-discussion.png" alt="Consultation médicale" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
